...
//         <Image
//           source={Back}
//           style={{ width: 40, height: 40, top: 50, position: "absolute", left: 20 }}
//         />
//       </TouchableOpacity>
//       <Text
//         style={{
...
//       </Text>
//       <View style={{ gap: 50, top: 100, left: 50 }}>
//         <Text style={{ fontSize: 20, fontWeight: "500", color: isDarkMode ? 'white' : 'black' }}>Edit Profile</Text>
//         <Text style={{ fontSize: 20, fontWeight: "500", color: isDarkMode ? 'white' : 'black' }}>Reset Password</Text>
//         <Text style={{ fontSize: 20, fontWeight: "500", color: isDarkMode ? 'white' : 'black' }}>Change Language</Text>
//         <View style={{ flexDirection: "row", alignItems: "center" }}>
//           <Text style={{ fontSize: 20, fontWeight: "500", color: isDarkMode ? 'white' : 'black' }}>Dark Mode</Text>
//           <Switch
