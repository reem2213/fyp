...
//   return (
//     <>
//       <View style={[styles.container, { backgroundColor: isDarkMode ? "#1A1A1A" : "#719AEA" }]}>
//         <TouchableOpacity onPress={backToHome}>
//           <Image source={Back} style={styles.backButton} />
//         </TouchableOpacity>
//         <Text style={[styles.header, { color: isDarkMode ? "#fff" : "white" }]}>{type}</Text>
//         <Image source={image} style={styles.feedbackImage} />
//       </View>
//       <View style={{ flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: isDarkMode ? "#1A1A1A" : "#fff" }}>
//         <Text
//           style={{
//             left: 230,
//             fontSize: 22,
...
//       <ScrollView style={{ backgroundColor: isDarkMode ? "#1A1A1A" : "#fff" }}>
//         <View style={[styles.containerr, { backgroundColor: isDarkMode ? "#1A1A1A" : "#fff" }]}>
//           <Text style={[styles.label, { color: isDarkMode ? "#fff" : "#999999" }]}>Select the date for {name}</Text>

//           <TouchableOpacity style={[styles.input, { backgroundColor: isDarkMode ? "#3A3A3A" : "#fff" }]} onPress={showDatePicker}>
//             <Text style={[styles.date, { color: isDarkMode ? "#fff" : "#fff" }]}>
//               {dateOfBirth ? (
//                 `Date: ${dateOfBirth.toDateString()}`
//               ) : (
//                 <Text>Choose a date</Text>
...
//           <Text style={[styles.label, { color: isDarkMode ? "#fff" : "#999999" }]}>Available Times for {name}</Text>
//           <ScrollView
//             style={styles.optionsContainer}
//             horizontal
//             showsHorizontalScrollIndicator={false}
...
//           <Text style={[styles.label, { color: isDarkMode ? "#fff" : "#999999" }]}>Select the duration</Text>
//           <ScrollView
//             style={styles.optionsContainer}
//             horizontal
//             showsHorizontalScrollIndicator={false}
...
//           <Text style={[styles.label, { color: isDarkMode ? "#fff" : "#999999" }]}>Meeting Type</Text>
//           <View style={styles.toggleContainer}>
//             <TouchableOpacity
//               style={[
//                 styles.toggleOption,
...
//           <Text style={[styles.label, { color: isDarkMode ? "#fff" : "#999999" }]}>Meeting Location</Text>
//           <TextInput
//             style={[
//               styles.textInput,
//               { backgroundColor: isDarkMode ? "#3A3A3A" : "#EFEFEF", color: isDarkMode ? "#fff" : "#032B79" },
//             ]}
//             placeholder="Enter the location"
//             value={location}
//             onChangeText={setLocation}
