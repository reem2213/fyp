...
//     // Create a new array with the updated ratings
//     const updatedFeedbacks = feedbacks.map((item, idx) => {
//       if (idx === index) {
//         return { ...item, rating }; // Update the rating for the selected item
//       }
//       return item; // Return other items unchanged
//     });
//     setFeedbacks(updatedFeedbacks); // Set the updated feedbacks array to state
//   };
...
//         key={item}
//         activeOpacity={0.7}
//         onPress={() => handleRatingChange(item, key)}
//       >
//         <Image
//           style={styles.Imgrating}
//           source={item <= feedbacks[key].rating ? { uri: starImgFilled } : { uri: starImgCorner }}
//         />
//       </TouchableOpacity>
//     );
//   })}
